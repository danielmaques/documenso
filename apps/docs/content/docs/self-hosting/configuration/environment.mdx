...
| `NEXT_PRIVATE_PADDLE_API_KEY`        | Paddle API key for billing                       |
| `NEXT_PRIVATE_PADDLE_WEBHOOK_SECRET` | Paddle webhook secret                            |
| `NEXT_PRIVATE_PADDLE_ENVIRONMENT`    | Paddle environment (`sandbox` or `production`)   |
| `NEXT_PRIVATE_PADDLE_API_URL`        | Optional Paddle API URL override                 |
