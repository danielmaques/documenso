declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    NEXT_PRIVATE_PADDLE_API_KEY?: string;
    NEXT_PRIVATE_PADDLE_WEBHOOK_SECRET?: string;
    NEXT_PRIVATE_PADDLE_ENVIRONMENT?: 'sandbox' | 'production';
    NEXT_PRIVATE_PADDLE_API_URL?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_INDIVIDUAL_MONTHLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_INDIVIDUAL_YEARLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_TEAM_MONTHLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_TEAM_YEARLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_PLATFORM_MONTHLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_PLATFORM_YEARLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_ENTERPRISE_MONTHLY?: string;
    NEXT_PRIVATE_PADDLE_PRICE_ID_ENTERPRISE_YEARLY?: string;
